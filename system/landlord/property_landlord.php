        ...
        if(mysqli_num_rows($result) > 0) {
            ...
            <div class="property-listing">
                ...
                <div class="column">
                    ...
                    <div class="icon-box">
                        <span>rooms<h2><?php echo $row["rooms"]; ?><span
                                    class="material-icons-sharp">meeting_room</span></h2></span>
                    </div>
                ...
                <div class="popup-box">
                    <div class="popup-content">
                        ...
                        <form action="update_property.php" method="post">
                            ...
                            <label for="property-name"><b>Property Name</b></label>
                            <input type="text" value="<?php echo $row["property_name"]; ?>" name="property-name"
                                required>
                            <label for="city"><b>City</b></label>
                            <input type="text" value="<?php echo $row["city"]; ?>" name="city" required>
                            <label for="street-address"><b>Street Address</b></label>
                            <input type="text" value="<?php echo $row["street_address"]; ?>" name="street-address"
                                required>
                            <label for="monthly-rate"><b>Monthly Rate</b></label>
                            <input type="number" value="<?php echo $row["monthly_rate"]; ?>" name="monthly-rate"
                                required>
                            <label for="rooms"><b>Rooms</b></label>
